# This file was *autogenerated* from the file monoAttack.sage
	...
	for c in line:
		if(c.isalpha()):
			...
			if(c in alphabetCount):
				alphabetCount[c]+=_sage_const_1 
			else:
				alphabetCount[c]=_sage_const_1 


sortedCount = sorted(alphabetCount.iteritems(), key=lambda x: x[_sage_const_1 ] , reverse=_sage_const_1 )
sortedAlpha = [item[_sage_const_0 ] for item in sortedCount]

fin.seek(_sage_const_0 )		#file pointer back to the head of the file
decrytp = ""
